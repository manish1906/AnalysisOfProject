...
--          Returns the last two orders for customer 29565.

SELECT * FROM Sales.GetLastOrdersForCustomer(29565,2);
GO
...
CROSS APPLY Sales.GetLastOrdersForCustomer(c.CustomerID,2) AS glofc
