...
-- Task 1: Alter procedure Reports.GetProductColors to execute as OWNER
...
-- Task 2: Alter procedure Reports.GetProductsAndModels to execute as OWNER
...
-- Task 3:lter procedure Reports.GetProductsByColor to execute as OWNER
