...
USE HumanResources;
GO
SELECT	EmployeeId, ShiftId, RegisteredStartTime, RegisteredEndTime, $PARTITION.pfHumanResourcesDates(RegisteredStartTime) AS PartitionNumber
FROM	Timesheet;
GO
...
DECLARE @p int = $PARTITION.pfHumanResourcesDates('2018-10-01 00:00');
...
ALTER PARTITION FUNCTION pfHumanResourcesDates() MERGE RANGE('2018-10-01 00:00');
GO
...
ALTER PARTITION FUNCTION pfHumanResourcesDates() SPLIT RANGE('2019-07-01 00:00');
GO

-- Insert data for the new period
INSERT INTO Timesheet
VALUES (1,1, '2019-05-21 07:00', '2019-05-21 15:00');
GO
INSERT INTO Timesheet
VALUES (1,1, '2019-05-23 07:00', '2019-05-23 15:00');
GO
